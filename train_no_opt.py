...
from bme1312.utils import compute_psnr, compute_ssim  # Removed lr_scheduler
...
class UNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        ...
        # Removed dropout layer initialization
...
def train(
    ...
    # Setup optimizer
    param_list = (
        list(model.parameters()) + list(model2.parameters()) + list(model3.parameters())
    )
    ...
    for epoch in range(num_epochs):
        # Removed learning rate scheduling logic

        # Training phase
        train_loss = train_epoch(
            model, model2, model3, dataloader_train, optimizer, criterion
        )
    ...
    test_results = test_models(
        model, model2, model3, dataloader_test, criterion, base_dir
    )
